...
public interface IBaseDao {
	...
	<T extends AggregateRoot> T findById(Class<T> entityClass,
										 String primaryKey);
	<T extends AggregateRoot> T find(Class<T> entityClass, String field,
									 Object value);

    <T extends AggregateRoot> List<T> finds(Class<T> entityClass, String field,
											Object value);

    <T extends AggregateRoot> List<T> findLike(Class<T> entityClass,
											   String field, Object value);

    <T extends AggregateRoot> List<T> findByIds(Class<T> entityClass,
												List primaryKeys);
